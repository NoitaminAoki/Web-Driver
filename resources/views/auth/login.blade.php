...
<html lang="en">
<head>
    <title>Masuk Pengemudi - Cleo Driver</title>
    <meta charset="UTF-8">
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-form-title-login" style="background-image: url({{asset('img/items/backhome3.jpg')}});">
                ...
                <form class="login100-form validate-form" method="POST" action="{{ route('auth.login.custom') }}">
                    ...
                    <div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
                        <span class="label-input100">Nomor PIN</span>
                        <input class="input100" type="password" name="password" required autocomplete="current-password" placeholder="Masukkan Nomor PIN">
                        <span class="focus-input100"></span>
                    </div>
